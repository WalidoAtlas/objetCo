...
// the loop routine runs over and over again forever:
  void loop() {
    ...
    if(alogene<128){
      value=map(alogene,0,128,0,255);//le map prend en premier parametre la valeur a modifier . les deux premier nombre serve a determiner un intervalle . les deux derniers definissent le comportement.
